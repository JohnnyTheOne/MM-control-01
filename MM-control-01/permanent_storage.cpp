...
static const uint16_t eepromBowdenLenDefault = 20250u; //!< Default bowden length (~1000 mm)
static const uint16_t eepromBowdenLenMinimum = 18225u; //!< Minimum bowden length (~900 mm)
static const uint16_t eepromBowdenLenMaximum = 22275u; //!< Maximum bowden length (~1100 mm)
